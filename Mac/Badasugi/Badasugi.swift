    ...
    init() {
        ...
        // Attempt 2: Try in-memory storage
            ...
            DispatchQueue.main.async {
                ...
                alert.informativeText = "받아쓰기가 저장소 위치에 접근할 수 없습니다. 세션 간 기록 내용이 저장되지 않습니다."
    ...
    private static func createPersistentContainer(schema: Schema, logger: Logger) -> ModelContainer? {
        do {
            ...
            let appSupportURL = FileManager.default.urls(for: .applicationSupportDirectory, in: .userDomainMask)[0]
                .appendingPathComponent("Badasugi", isDirectory: true)
                ...
                ContentView()
                    ...
                    .onAppear {
                        ...
                        if containerInitializationFailed {
                            ...
                            alert.informativeText = "받아쓰기가 저장소 시스템을 초기화할 수 없습니다. 앱을 계속할 수 없습니다.\n\n문제가 지속되면 앱을 재설치하거나 지원팀에 문의하세요."
