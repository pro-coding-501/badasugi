...
struct WordReplacementView: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            HStack(spacing: 6) {
                ...
                Text("특정 단어나 구문을 자동으로 교체할 단어 교체 정의")
                    .font(.system(size: 11))
                    .foregroundColor(.secondary)
            }

            HStack(spacing: 8) {
                TextField("원본 텍스트 (여러 개는 쉼표로 구분)", text: $originalWord)
                ...
                TextField("교체 텍스트", text: $replacementWord)
                    .textFieldStyle(.roundedBorder)
                    .font(.system(size: 13))
    ...
    private func addReplacement() {
        ...
        do {
            ...
            alertMessage = "교체 추가 실패: \(error.localizedDescription)"
            showAlert = true
        }
    }
    ...
    private func removeReplacement(_ replacement: WordReplacement) {
        ...
        do {
            ...
            alertMessage = "교체 제거 실패: \(error.localizedDescription)"
            showAlert = true
        }
    }
}
