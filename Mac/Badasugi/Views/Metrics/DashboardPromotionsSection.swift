            ...
            HStack(alignment: .top, spacing: 18) {
                if shouldShowUpgradePromotion {
                    DashboardPromotionCard(
                        badge: "30% 할인",
                        title: "받아쓰기 Pro를 더 저렴하게",
                        message: "소셜 미디어에 받아쓰기를 공유하면 받아쓰기 Pro 30% 할인을 즉시 받을 수 있습니다.",
                        accentSymbol: "megaphone.fill",
                        glowColor: Color(red: 0.08, green: 0.48, blue: 0.85),
                        actionTitle: "공유하고 할인받기",
                ...
                if shouldShowAffiliatePromotion {
                    DashboardPromotionCard(
                        badge: "제휴 30%",
                        title: "받아쓰기 제휴 프로그램으로 수익 창출",
                        message: "친구나 팔로워에게 받아쓰기를 공유하고, 업그레이드하는 모든 추천에 대해 30%를 받으세요.",
                        accentSymbol: "link.badge.plus",
                        glowColor: Color(red: 0.08, green: 0.48, blue: 0.85),
                        actionTitle: "제휴 프로그램 알아보기",
                        actionIcon: "arrow.up.right",
