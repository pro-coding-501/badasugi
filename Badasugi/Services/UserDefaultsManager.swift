...
extension UserDefaults {
    enum Keys {
        static let aiProviderApiKey = "BadasugiAIProviderKey"
        static let licenseKey = "BadasugiLicense"
        static let trialStartDate = "BadasugiTrialStartDate"
        static let audioInputMode = "audioInputMode"
        static let selectedAudioDeviceUID = "selectedAudioDeviceUID"
        static let prioritizedDevices = "prioritizedDevices"
        static let affiliatePromotionDismissed = "BadasugiAffiliatePromotionDismissed"
