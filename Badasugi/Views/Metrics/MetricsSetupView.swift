...
struct MetricsSetupView: View {
    ...
    private func setupStep(for index: Int) -> some View {
        ...
        case 0:
            stepInfo = (
                ...
                icon: "command",
                title: "키보드 단축키 설정",
                description: "단축키로 어디서나 받아쓰기를 사용하세요."
            )
        case 1:
            stepInfo = (
                ...
                title: "접근성 활성화",
                description: "기록된 텍스트를 커서 위치에 붙여넣습니다."
            )
        case 2:
            stepInfo = (
                ...
                icon: "video.fill",
                title: "화면 녹화 권한 활성화",
                description: "화면 컨텍스트로 더 나은 기록을 받으세요."
            )
        default:
            stepInfo = (
                ...
                title: "모델 다운로드",
                description: "기록을 시작할 AI 모델을 선택하세요."
            )
        }
    ...
    private var helpText: some View {
        Text("도움이 필요하신가요? 도움말 메뉴에서 지원 옵션을 확인하세요")
            .font(.caption)
            .foregroundColor(.secondary)
    }
